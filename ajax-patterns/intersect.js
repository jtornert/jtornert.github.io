(() => {
        ...
        Alpine.directive(
            ...
            Alpine.skipDuringClone(
                (
                    ...
                    let options = {
                        root: getRootElement(el, modifiers),
    ...
    function getRootElement(el, modifiers) {
        if (!modifiers.includes("root")) return undefined;
        let root = modifiers[modifiers.indexOf("root") + 1];
